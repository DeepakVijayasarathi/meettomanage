...
export const PAYOUTS: TeacherPayout[] = [
  { id: "pay-1", teacherId: "t-1", teacherName: "Karan Mehta", month: "June 2026", sessionsCompleted: 42, baseAmount: 37800, deductions: 600, waitingAmountAdded: 300, finalAmount: 37500, status: "paid", requiresReview: false, items: [] },
  ...
  { id: "pay-6", teacherId: "t-1", teacherName: "Karan Mehta", month: "July 2026", sessionsCompleted: 16, baseAmount: 14400, deductions: 0, waitingAmountAdded: 150, finalAmount: 14550, status: "pending", requiresReview: false, items: [] },
  {
    ...
    requiresReview: true,
    items: [
      { id: "item-demo-1", classSessionId: "session-demo-1", type: "SessionEarning", amount: 1100, note: "Teacher attended only 10 of 45 scheduled minutes -- review before finalizing.", requiresReview: true },
    ],
  },
