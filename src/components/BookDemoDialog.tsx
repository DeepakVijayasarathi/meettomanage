...
/**
 * Public "Book a free demo" form — no account needed. Shared between the marketing
 * home page and the Store page so there's exactly one implementation of the real
 * booking flow (backend call, slot picker, demo-mode fallback) instead of two.
 */
export function BookDemoDialog({ open, onOpenChange }: BookDemoDialogProps) {
  ...
  }, [live, open, demoDate, loadAvailableSlots]);
      ...
      <DialogContent className="max-w-md">
        {demoConfirmed ? (
          <div className="flex flex-col items-center py-4 text-center">
            ...
            <Button className="mt-6 !bg-[#F97316] !text-white hover:!bg-[#EA580C]" onClick={() => onOpenChange(false)}>
              Done
            </Button>
          </div>
        ) : (
